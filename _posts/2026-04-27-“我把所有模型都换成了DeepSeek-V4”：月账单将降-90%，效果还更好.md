...
科技博主兼AI系统架构师 Sean Donahoe 在今天凌晨发了一条帖子。他写道：
...
![](https://static001.geekbang.org/infoq/c7/c7b0d37e964b547531e4326ac91dfd8d.jpeg)
...
![](https://static001.geekbang.org/infoq/1d/1d826abf75e7473d8fa01d16ebdc9a40.png)
...
OpenAI 的旗舰模型过去通常比 Anthropic 更便宜，但这一次不一样了：GPT-5.5 的 API 定价为每百万输入 token 5 美元、每百万输出 token 30 美元，比前代GPT-5.4贵了一倍，甚至比Claude Opus 4.7的输出定价还贵出一截。

更值得注意的是，OpenAI为GPT-5.5设计了一套复杂的定价分层。除了标准API之外，OpenAI 还提供了一个优先级（priority）套餐，价格是标准档的 2.5 倍。如何为“更快的 token”收更多钱，正在变得越来越关键。这里需要说明的是，priority 和 fast mode 是两回事。fast mode 只是给出一些相对模糊的承诺，比如“价格贵 6 倍，速度大约快 2.5 倍”；而 priority 提供的是更保守但更明确的 SLA（例如：99% 的时间里吞吐量超过 50 tokens/s）。

这还没算GPT-5.5 Pro——专为科学研究和长程推理设计的版本，输入/输出定价分别为每百万token 30美元和180美元，瞄准的不是日常编码场景，而是前沿科研用例。
...
![](https://static001.geekbang.org/infoq/5b/5b5e73f5b7901a28ed60b9a7d490bbc9.jpeg)

如果把当前主流模型的定价放在一张表里看，这种分化更加直观：

![](https://static001.geekbang.org/infoq/b8/b8f891126288850d5eff1c82c65157ff.jpeg)
...
![](https://static001.geekbang.org/infoq/3b/3b64e342b92df7c95233a5dc2e75c302.jpeg)
...
工具也完全统一，两个模型生成时，用的都是 Claude Code。你猜哪个是DeepSeek的？

![](https://static001.geekbang.org/infoq/c0/c004ee25197736411889058f9328da31.png)

![](https://static001.geekbang.org/infoq/d2/d29c82312d954596809416c6f6da2712.png)

不过，在日常问题上，DeepSeek确实更强：

![](https://static001.geekbang.org/infoq/eb/ebbc535ec4622d7bd83c0bf2bf38e01c.png)

![](https://static001.geekbang.org/infoq/af/aff29ca4bc82488170b9f4226f34e7bf.png)
...
![](https://static001.geekbang.org/infoq/44/448ac048236c140a0fdc3d19358738ee.png)

DeepSeek-V3-0324

![](https://static001.geekbang.org/infoq/a1/a1067f63482e3c8cc75baa13a328e836.png)

DeepSeek-V3.1

![](https://static001.geekbang.org/infoq/27/27f1457bad85c301ff57cc53488745c8.png)

DeepSeek-V3.2

![](https://static001.geekbang.org/infoq/14/144e37e1f491de30621d17f978083a43.png)

DeepSeek-V4 Flash

![](https://static001.geekbang.org/infoq/20/20ca9ed854be57b254b749bd5d1d8c14.png)
...
[https://x.com/rohanpaul_ai/status/2047762509474726285](https://x.com/rohanpaul_ai/status/2047762509474726285)

[https://simonwillison.net/2026/apr/24/deepseek-v4/](https://simonwillison.net/2026/apr/24/deepseek-v4/)

[https://linux.do/t/topic/2045480](https://linux.do/t/topic/2045480)

[https://venturebeat.com/technology/deepseek-v4-arrives-with-near-state-of-the-art-intelligence-at-1-6th-the-cost-of-opus-4-7-gpt-5-5](https://venturebeat.com/technology/deepseek-v4-arrives-with-near-state-of-the-art-intelligence-at-1-6th-the-cost-of-opus-4-7-gpt-5-5)

[https://www.facebook.com/groups/techtitansgroup/posts/1642732440387401/](https://www.facebook.com/groups/techtitansgroup/posts/1642732440387401/)



> *本文由 AI 助手自动生成并排版自 InfoQ，原文链接：[“我把所有模型都换成了DeepSeek V4”：月账单将降 90%，效果还更好](https://www.infoq.cn/article/e4UXTsCToLXsRVEWNUqW)*
