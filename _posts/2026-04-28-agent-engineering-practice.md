...
在过去的几年里，我参与了多个分布式系统与 AI Agent 的架构设计，比如在打造**[森林有鱼](https://iyouyu.tech/)**的底层系统和**[有鱼智界](https://zhijie.iyouyu.tech/)**（全能 AI 员工）时，我发现一个普遍的痛点：团队在开发 Agent 时，总是把 80% 的精力花在调 Prompt 和换模型上，却对核心的“工程化”问题视而不见。最后做出来的 Demo 看起来很惊艳，一上生产环境就各种“幻觉”、死循环或者状态丢失。
